...
public class StringTransactionalConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String message) {
        System.out.printf("Consumer: spring-transaction-topic received: %s \n", message);
    }
}
*/
...
@Service
@RocketMQMessageListener(topic = "${demo.rocketmq.transTopic}", consumerGroup = "string_trans_consumer")
public class StringTransactionalConsumer implements RocketMQListener<MessageExt>{
    @Override
    public void onMessage(MessageExt messageExt) {
        System.out.printf("Consumer: spring-transaction-topic received \n" );
